...
insert into coches (matricula,numeroBastidor,marca,modelo,añoFabricacion,color,numeroPlazas,numeroPuertas,grandariaMaletero,combustible) values("6178CBY","WXEKGUITVOKH0FAXK","Ford","Mustang Fastback",1966,"Negro",5,3,220,"Gasolina");
insert into coches (matricula,numeroBastidor,marca,modelo,añoFabricacion,color,numeroPlazas,numeroPuertas,grandariaMaletero,combustible) values("M5512DS","TENZ6KL0CDH7P01KD","Chevrolet","Bel Air",1957,"Azul Turquesa",5,5,280,"Gasolina");
...
insert into coches (matricula,numeroBastidor,marca,modelo,añoFabricacion,color,numeroPlazas,numeroPuertas,grandariaMaletero,combustible) values("B8956LM","MZ05RMROFZJR4VIDM","BMW","M30 E30",1988,"Negro",5,3,210,"Gasolina");
insert into coches (matricula,numeroBastidor,marca,modelo,añoFabricacion,color,numeroPlazas,numeroPuertas,grandariaMaletero,combustible) values("M4563ZZ","28TKPI9UM42V45IK2","SEAT","600D",1965,"Rojo",5,3,125,"Gasolina");
insert into coches (matricula,numeroBastidor,marca,modelo,añoFabricacion,color,numeroPlazas,numeroPuertas,grandariaMaletero,combustible) values("B1245CC","B9N7VXF5Z040CH2IY","Mercedes","190 E 2.5-16 Evo II",1990,"Negro",5,5,200,"Gasolina");
